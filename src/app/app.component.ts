...
export class AppComponent {
  ...
  filmesAcao = [
    { titulo: 'O Pacto', descricao: 'Durante a guerra no Afeganistão, um intérprete arrisca sua vida para carregar um sargento ferido por quilômetros de terreno hostil em busca de um local seguro.', imagem: 'https://cinecriticas.com.br/wp-content/uploads/2023/06/Cine1-12-scaled.jpg' },
    ...
    { titulo: 'A bailarina', descricao: 'Sofrendo com a morte da melhor amiga após não conseguir protegê-la, uma antiga guarda-costas vai fazer de tudo para realizar seu último pedido: vingança.', imagem: 'https://br.web.img3.acsta.net/pictures/23/09/18/23/21/0756025.png' },
  ];

  filmesComedia = [
    { titulo: 'Luck', descricao: 'A corajosa e azarada Sam Greenfield se aventura na encantada Terra da Sorte, onde terá que se aliar a criaturas mágicas para mudar seu destino', imagem: 'https://upload.wikimedia.org/wikipedia/pt/6/6e/Luck_%282022%29_poster.png' },
    { titulo: 'Leo', descricao: 'Após décadas preso na escola, o lagarto Leo planeja conseguir sua liberdade.', imagem: 'https://observatoriodocinema.uol.com.br/wp-content/uploads/2023/10/leo-poster.jpeg' },
  ...
  filmesTerror = [
    ...
    { titulo: 'Pearl', descricao: 'Presa em uma fazenda isolada, Pearl deve cuidar de seu pai doente sob a vigilância de sua mãe. Desejando a vida glamouroso que ela viu nos filmes, as tentações e repressões de Pearl colidem.', imagem: 'https://upload.wikimedia.org/wikipedia/pt/4/46/Pearl_2022.jpg ' },
